...
from agent.h64 import HierarchyAgent
...
flags.DEFINE_integer('input_dim', 3200, 'input dimension')
flags.DEFINE_integer('size_manager', 2, 'for MNIST: side of the square for manager')
flags.DEFINE_integer('size_worker', 4, 'for MNIST: side of the square for worker')
